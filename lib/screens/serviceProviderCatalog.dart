          ...
          TargetContent(
            ...
            builder: (context, controller) {
              return CoachmarkDesc(
                text:
                "Tap the '+' button to include new items in your catalog. This feature allows you to expand your service range by adding new items or services you provide. Whether it's a new paint color, a special tool, or a unique service, use this space to keep your catalog up-to-date and appealing to your clients.",
                onNext: () {
                  controller.next();
                },
                onSkip: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: jsonList.length == 0
        ...
        children: [
          Center(
            child: Text('There is no catalog items to see here...',
              style: TextStyle(
