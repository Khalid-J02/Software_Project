...
class ChatMessages extends StatefulWidget {
  ...
  ChatMessages({super.key, required this.receiverID , required this.messages});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isTextMessage = widget.messages[index].messageType == MessageType.text;

        return isTextMessage
            ? MessageBubble(message: widget.messages[index], isMe: isMe, isImage: false,)
            : MessageBubble(message: widget.messages[index], isMe: isMe, isImage: true,);
      },
    );
  }
}