      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(
              translation(context)!.forgetPasswordMainTitle,
              style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
              translation(context)!.forgetPasswordDescriptionMainTitle,
              style: TextStyle(
                  fontSize:MediaQuery.of(context).size.width > 930
                      ? 18
                      : 14,
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                hintText: translation(context)!.forgetPasswordEmailAddressHintText,
                hintStyle: TextStyle(color: Color(0xFFF3D69B)),
                filled: true,
                fillColor: Color(0xFF2F4771),
                labelText: translation(context)!.forgetPasswordEmailAddress,
          ...
          Container(
            ...
            child: TextButton(
              ...
              child: Text(
                translation(context)!.forgetPasswordResetAddress,
                style: TextStyle(
                  fontSize: MediaQuery.of(context).size.width > 930
                      ? 19
                      : 16,
