      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(
              translation(context)!.forgetPasswordCodeMainTitle,
              style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
            translation(context)!.forgetPasswordCodeDescriptionMainTitle,
              style: TextStyle(
                  fontSize: MediaQuery.of(context).size.width > 930
                      ? 18
                      : 14,
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                hintText: translation(context)!.forgetPasswordCodeVerificationCodeHintText,
                hintStyle: TextStyle(color: Color(0xFFF3D69B)),
                filled: true,
                fillColor: Color(0xFF2F4771),
                labelText: translation(context)!.forgetPasswordCodeVerificationCode,
            ...
            children: <Widget>[
              Container(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    translation(context)!.forgetPasswordCodeBack,
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    translation(context)!.forgetPasswordCodeNext,
                    style: const TextStyle(
                      fontSize: 16,
                      color: Color(0xFFF3D69B),
                    ),
