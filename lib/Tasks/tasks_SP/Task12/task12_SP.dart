...
class _TileInstallSPSPState extends State<TileInstallSP> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      if (tileData['TaskStatus'] == 'Completed') {
        setState(() {
            ...
            child: Column(
              children: [
                TaskInformation(
                  ...
                  taskName: translation(context)!.sp_task12Name,
                  projectName: tileData['ProjectName'] ?? 'Unknown',
                  taskStatus: translateTaskStatus(tileData['TaskStatus'], context),
                ),
                                ...
                                children: [
                                   Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        translation(context)!.sp_task12BathroomTile,
                                        style:  TextStyle(
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      if( tileData['BathroomTile']!=null){
                                        await openCatalog( tileData['BathroomTile'].toString(),context);
                                      }
                                      else{
                                ...
                                children: [
                                   Expanded(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(left: 8, right: 8),
                                      child: Text(
                                        translation(context)!.sp_task12HouseTile,
                                        style:  TextStyle(
                                            color: const Color(0xFF2F4771),
                                            fontWeight: isRtl? FontWeight.w500: FontWeight.w800,
                                            fontSize: isRtl? 16: 19),
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      if( tileData['HouseTile']!=null){
                                        await openCatalog( tileData['HouseTile'].toString(),context);
                                      }
                                      else{
                                        await openCatalog('null',context);
                                      }
