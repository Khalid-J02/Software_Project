          ...
          child: Column(
            children: [
              TaskInformation(
                ...
                taskName: paintingData['TaskName'] ?? 'Unknown',
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text(
                                "Choose Painting For The Following: ",
                                style: TextStyle(
                                    color: Color(0xFF2F4771),
                                    fontSize: 17,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    await openCatalog(paintingData['BedroomPaint'].toString()) ;
                                  },
                                  child: Container(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    await openCatalog(paintingData['BathroomPaint'].toString()) ;
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.only(top: 5 , right: 5),
                                    height: 40,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    await openCatalog(paintingData['LivingroomPaint'].toString()) ;
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.only(top: 5 , right: 5),
                                    height: 40,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    await openCatalog(paintingData['GuestroomPaint'].toString()) ;
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.only(top: 5 , right: 5),
                                    height: 40,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () async {
                                    await openCatalog(paintingData['KitchenPaint'].toString()) ;
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.only(top: 5 , right: 5),
                                    height: 40,
