...
class _ElectricalInstallSPState extends State<ElectricalInstallSP> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      if (electricalData['TaskStatus'] == 'Completed') {
        setState(() {
