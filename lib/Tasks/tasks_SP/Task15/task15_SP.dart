...
class _DoorInstallationSPState extends State<DoorInstallationSP> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      if (doorData['TaskStatus'] == 'Completed') {
        setState(() {
            ...
            child: Column(
              children: [
                TaskInformation(
                  ...
                  taskName:  translation(context)!.sp_task14Name,
                  projectName: doorData['ProjectName'] ?? 'Unknown',
                  taskStatus:translateTaskStatus(doorData['TaskStatus'], context),
                ),
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        translation(context)!.sp_task14Design,
                                        style:  TextStyle(
                                  ...
                                  GestureDetector(
                                    onTap: () async {
                                      if( doorData['DoorDesign']!=null){
                                        await openCatalog( doorData['DoorDesign'].toString(),context);
                                      }
                                      else{
