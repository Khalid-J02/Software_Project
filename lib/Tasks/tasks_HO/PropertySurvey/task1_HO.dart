        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SPProfileData(userPicture: propertySurveyData['UserPicture'], rating: (propertySurveyData['Rating'] as num?)?.toDouble() ?? 0.0, numReviews: propertySurveyData['ReviewCount']?? 0, userName:propertySurveyData['Username']?? 'Unknown',),
              Container(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Get.to(DocsPdfViewer(pdfFileURL: surveyDocument,));
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.only(top: 5 , right: 5),
                                    height: 35,
